<!-- Lineas que hay que cambiar cuando esto esté montado:
  - 2213 href vacio -> llevar a FAQ
  - 2216 action del form
  - 2229 primer text field del login
  - 2235 segundo text field del login
  - 2257 href vacio llevar a FAQ
  - 2270 llevar a FAQ
  - 2276 llevar a login de lorenzo
  - 2279 llevar a login de lorenzo
-->
...
<html lang="en" dir="ltr">
  ...
  <body>
      <nav class="navbar navbar-light navbar-expand-md shadow-sm navigation-clean-button">
          <div class="container-fluid"><a class="navbar-brand" href="#" style="height: 100px;"><img src="assets/img/Imagen1.png" width="125"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
              <div
                                    ...
                                    <form action="" method="post" name="formulario1" id="formulario1">
                                        <div id="userpass" style="position:relative;">
                                            <div class="form-item" id="edit-name-wrapper">
                                                ...
                                                <div class="form-col2">
                                                  <input class="text-field" type="text"  name="" id="edit-name">
                                                </div>
                                            ...
                                            <div class="form-item" id="edit-pass-wrapper">
                                                ...
                                                <div class="form-col2">
                                                  <input class="text-field" type="password" name="" id="edit-pass">
                                                </div>
                                            </div>
                                        ...
                                        <ul>
                                          <li>
                                            <img id="icon_otraorganizacion" src="https://idp.uma.es/adas/themes/uma-1.7.0/img/otraorganizacion.png">
                                              <a id="wayf_button" href="">Quiero autenticarme como organización</a>
                                          </li>
                                        </ul>
                                    </div>

<?php
  ...
  if(isset($_GET['id'])){
    $query = "DELETE Actividad_Habilidad FROM Actividad_Habilidad, Actividad WHERE actividad = Actividad.ID and Actividad.propuestaPor = '".$_GET['id']."'";
    mysqli_query($conexion,$query);
    $query = "DELETE FROM Actividad where propuestaPor='".$_GET['id']."'";
    mysqli_query($conexion,$query);
    $query = "DELETE FROM ONG where email='".$_GET['id']."'";
    mysqli_query($conexion,$query);
    header('location: eliminar_ongs.php');
  }
             ...
             <div class="col-xl-8">
                 <div class="row">
                     <div class="col-md-4 col-lg-10 col-xl-12 text-center">
                         <div class="row">
                             <div class="col">
                                 <h1 class="text-left" style="color: #56c6c6;padding-top: 20px;padding-bottom: 20px;">Organizaciones Colaboradoras</h1>
                             </div>
                         </div>
                         ...
                         <?php
                          ...
                          echo "<div class='col' style='margin-top: 20px; border: 1px solid #56c6c6; border-radius: 10px;'>
                                ...
                                <p class='text-left'>Descripcion: ".$rows['description']."</p>
                                <p class='text-left'>Página Web: ".$rows['website']."</p>
                                <div class='row' style='margin-left: 1px'>
                                  <form action='".$_SERVER['PHP_SELF']."?id=".$rows['email']."' method='post'>

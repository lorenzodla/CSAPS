          ...
          while($rows = mysqli_fetch_assoc($resultados)){
            echo "<div class='row' style='margin-top: 1%;'>
                <div class='col'>
                    ...
                    <h1 class='text-left'>".$rows['coordinador']."</h1>
                ...
                <div class="col-md-4 col-lg-10 col-xl-12 text-center">
                    ...
                    <?php
                        ...
                        while($rows = mysqli_fetch_assoc($resultados)){
                            ...
                            echo "<p style='font-size: 20px;font-weight: bold;' class='text-left'><a  href='insertar_relacion_actividad_asignatura.php?id=".$_GET['id']."&asignatura=".$rows['ID']."     '>".$rows['nombre']."</a></p>";                                           
                            ...
                            echo    
                                "<p class='text-left'>ID: ".$rows['ID']."</p>
                                 <p class='text-left'>Coordinador: ".$rows['coordinador']."</p>";

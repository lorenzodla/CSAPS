        ...
        <div class="col-xl-8">
            <div class="row">
                <div class="col-md-4 col-lg-10 col-xl-12 text-center">
                    ...
                    <?php
                      $query = "SELECT * FROM Actividad WHERE tipo LIKE 'DOCENCIA' AND NOT EXISTS (SELECT * FROM Asignatura_Actividad WHERE Asignatura_Actividad.actividad = Actividad.ID)";
                      $resultados = mysqli_query($conexion, $query);
                      while($rows = mysqli_fetch_assoc($resultados)){
                        echo "<div class='row' style='margin-top: 1%;'>";
                        echo "<div class='col' style='border: 1px solid #56c6c6; border-radius: 10px;'>";
                        echo "<p style='font-size: 20px;font-weight: bold;' class='text-left'><a  href='asignar_asignatura.php?id=".$rows['ID']."'>".$rows['Titulo']."</a></p>";
